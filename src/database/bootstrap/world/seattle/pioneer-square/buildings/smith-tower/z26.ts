...
export const building = {
  rooms: {
    ...
    // Elevator landing
    '%EL_z26': {
      name: 'Smith Tower - 26th Floor - Elevator Landing',
      ...
      exits: {
        ...
        south: { room: '%C3_z26', door: '%D_C3_z26' },
        in: '%E',
      },
      methods: {
    ...
    '%A1_z26': {
      name: 'Smith Tower - 26th Floor - North Suite - Living Room',
      ...
      methods: {
        ...
        onContentLeaving: "const obj = args[0];\nif (obj?.unregisterVerbsFrom) {\n  await obj.unregisterVerbsFrom(self.id);\n}",
        lookOutWindow: "const player = args[0];\nreturn 'From this height above Pioneer Square, you see nothing. Empty streets, rusted vehicles frozen mid-journey, weeds claiming the pavement. The only movement is wind stirring debris and the occasional bird cutting across the grey sky. The glass rattles in its frame as you stare down at fifty-five years of silence (floor 26).';",
    ...
    '%A2_z26': {
      name: 'Smith Tower - 26th Floor - North Suite - Bedroom',
    ...
    '%A3_z26': {
      name: 'Smith Tower - 26th Floor - North Suite - Studio',
    ...
    '%B1_z26': {
      name: 'Smith Tower - 26th Floor - East Suite - Loft',
    ...
    '%C1_z26': {
      name: 'Smith Tower - 26th Floor - South Suite - Alcove',
    ...
    '%B2_z26': {
      name: 'Smith Tower - 26th Floor - East Suite - Living Room',
    ...
    '%B3_z26': {
      name: 'Smith Tower - 26th Floor - East Suite - Den',
    ...
    '%C2_z26': {
      name: 'Smith Tower - 26th Floor - South Suite - Living Room',
    ...
    '%C3_z26': {
      name: 'Smith Tower - 26th Floor - South Suite - Foyer',
      description: 'The single entrance to the C block, with a stout fire door to the elevator.',
      x: -12, y: 9, z: 26,
      exits: {"north":{"room":"%EL_z26","door":"%D_C3_z26"},"west":"%C2_z26","east":"%C4_z26"},
      methods: {
        onContentArrived: "const obj = args[0];\nif (!obj?.registerVerb) return;\nawait obj.registerVerb(['look out window', 'look through window', 'gaze out window', 'look down'], self, 'lookOutWindow');",
        onContentLeaving: "const obj = args[0];\nif (obj?.unregisterVerbsFrom) {\n  await obj.unregisterVerbsFrom(self.id);\n}",
        lookOutWindow: "const player = args[0];\nreturn 'From this height above Pioneer Square, you see nothing. Empty streets, rusted vehicles frozen mid-journey, weeds claiming the pavement. The only movement is wind stirring debris and the occasional bird cutting across the grey sky. The glass rattles in its frame as you stare down at fifty-five years of silence (floor 26).';",
    ...
    '%C4_z26': {
      name: 'Smith Tower - 26th Floor - South Suite - Bedroom',
    ...
    '%B4_z26': {
      name: 'Smith Tower - 26th Floor - East Suite - Bedroom',
