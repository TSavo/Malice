...
export const building = {
  rooms: {
    ...
    // Elevator landing
    '%EL_z18': {
      name: 'Smith Tower - 18th Floor - Elevator Landing',
      description: 'A compact landing with scuffed brass trim and a single call panel.',
      x: -4, y: 8, z: 18,
      exits: {
        north: { room: '%A2_z18', door: '%D_A2_z18' },
        east: { room: '%B2_z18', door: '%D_B2_z18' },
        south: { room: '%C3_z18', door: '%D_C3_z18' },
        in: '%E',
      },
      methods: {
    ...
    '%A1_z18': {
      name: 'Smith Tower - 18th Floor - North Suite - Living Room',
      ...
      methods: {
        ...
        onContentLeaving: "const obj = args[0];\nif (obj?.unregisterVerbsFrom) {\n  await obj.unregisterVerbsFrom(self.id);\n}",
        lookOutWindow: "const player = args[0];\nreturn 'From this height above Pioneer Square, you see nothing. Empty streets, rusted vehicles frozen mid-journey, weeds claiming the pavement. The only movement is wind stirring debris and the occasional bird cutting across the grey sky. The glass rattles in its frame as you stare down at fifty-five years of silence (floor 18).';",
    ...
    '%A2_z18': {
      name: 'Smith Tower - 18th Floor - North Suite - Bedroom',
      description: 'A bright one-bedroom overlooking the skyline, hall-facing door to the south.',
      x: -4, y: 9, z: 18,
      exits: {"west":"%A1_z18","east":"%A3_z18","south":{"room":"%EL_z18","door":"%D_A2_z18"}},
      methods: {
        onContentArrived: "const obj = args[0];\nif (!obj?.registerVerb) return;\nawait obj.registerVerb(['look out window', 'look through window', 'gaze out window', 'look down'], self, 'lookOutWindow');",
        onContentLeaving: "const obj = args[0];\nif (obj?.unregisterVerbsFrom) {\n  await obj.unregisterVerbsFrom(self.id);\n}",
        lookOutWindow: "const player = args[0];\nreturn 'From this height above Pioneer Square, you see nothing. Empty streets, rusted vehicles frozen mid-journey, weeds claiming the pavement. The only movement is wind stirring debris and the occasional bird cutting across the grey sky. The glass rattles in its frame as you stare down at fifty-five years of silence (floor 18).';",
    ...
    '%A3_z18': {
      name: 'Smith Tower - 18th Floor - North Suite - Studio',
    ...
    '%B1_z18': {
      name: 'Smith Tower - 18th Floor - East Suite - Loft',
    ...
    '%C1_z18': {
      name: 'Smith Tower - 18th Floor - South Suite - Alcove',
    ...
    '%B2_z18': {
      name: 'Smith Tower - 18th Floor - East Suite - Living Room',
      description: 'A two-room suite with a west-facing door toward the elevator.',
      x: -3, y: 8, z: 18,
      exits: {"north":"%B1_z18","east":"%B3_z18","west":{"room":"%EL_z18","door":"%D_B2_z18"},"south":"%B4_z18"},
      methods: {
        onContentArrived: "const obj = args[0];\nif (!obj?.registerVerb) return;\nawait obj.registerVerb(['look out window', 'look through window', 'gaze out window', 'look down'], self, 'lookOutWindow');",
        onContentLeaving: "const obj = args[0];\nif (obj?.unregisterVerbsFrom) {\n  await obj.unregisterVerbsFrom(self.id);\n}",
        lookOutWindow: "const player = args[0];\nreturn 'From this height above Pioneer Square, you see nothing. Empty streets, rusted vehicles frozen mid-journey, weeds claiming the pavement. The only movement is wind stirring debris and the occasional bird cutting across the grey sky. The glass rattles in its frame as you stare down at fifty-five years of silence (floor 18).';",
    ...
    '%B3_z18': {
      name: 'Smith Tower - 18th Floor - East Suite - Den',
    ...
    '%C2_z18': {
      name: 'Smith Tower - 18th Floor - South Suite - Living Room',
    ...
    '%C3_z18': {
      name: 'Smith Tower - 18th Floor - South Suite - Foyer',
      description: 'The single entrance to the C block, with a stout fire door to the elevator.',
      x: -4, y: 7, z: 18,
      exits: {"north":{"room":"%EL_z18","door":"%D_C3_z18"},"west":"%C2_z18","east":"%C4_z18"},
      methods: {
        onContentArrived: "const obj = args[0];\nif (!obj?.registerVerb) return;\nawait obj.registerVerb(['look out window', 'look through window', 'gaze out window', 'look down'], self, 'lookOutWindow');",
        onContentLeaving: "const obj = args[0];\nif (obj?.unregisterVerbsFrom) {\n  await obj.unregisterVerbsFrom(self.id);\n}",
        lookOutWindow: "const player = args[0];\nreturn 'From this height above Pioneer Square, you see nothing. Empty streets, rusted vehicles frozen mid-journey, weeds claiming the pavement. The only movement is wind stirring debris and the occasional bird cutting across the grey sky. The glass rattles in its frame as you stare down at fifty-five years of silence (floor 18).';",
    ...
    '%C4_z18': {
      name: 'Smith Tower - 18th Floor - South Suite - Bedroom',
    ...
    '%B4_z18': {
      name: 'Smith Tower - 18th Floor - East Suite - Bedroom',
